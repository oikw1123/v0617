...
namespace v0617
{
    public partial class Form1 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            label4.Left = fpos.X - label3.Width / 2;
            label4.Top = fpos.Y - label3.Height / 2;
            label4.Text = $"{fpos.X},{fpos.Y}";

            label5.Left = fpos.X - label3.Width / 2;
            label5.Top = fpos.Y - label3.Height / 2;
            label5.Text = $"{fpos.X},{fpos.Y}";
